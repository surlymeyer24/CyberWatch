...
namespace CyberWatch.Service.Logging;

/// <summary>
/// Escribe los logs del servicio en un archivo (cyberwatch_service.log) para poder revisar actualizaciones, errores, etc.
/// </summary>
public sealed class FileLoggerProvider : ILoggerProvider
{
    ...
    public FileLoggerProvider(string? basePath, LogLevel minLevel = LogLevel.Information)
    {
        ...
        _logFilePath = Path.Combine(dir, "cyberwatch_service.log");
        _minLevel = minLevel;
    }
